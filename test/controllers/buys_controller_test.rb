...
class BuysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buy" do
    assert_difference('Buy.count') do
      post buys_url, params: { buy: { id: @buy.id, order_id: @buy.order_id, product_id: @buy.product_id, quantity: @buy.quantity } }
    end
  ...
  test "should update buy" do
    patch buy_url(@buy), params: { buy: { id: @buy.id, order_id: @buy.order_id, product_id: @buy.product_id, quantity: @buy.quantity } }
